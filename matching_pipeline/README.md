...
| Source images | `db/images/` | Authoritative; back up |
...
Monitor `cycle=... finished` log lines, stage tracebacks, disk use, pending-row trends, and nonzero image `failed_images`/`failed_pairs`. A running container does not prove each stage succeeded.
